...
namespace Lab5
{
    public partial class Form1 : Form
    {
        ...
        private async void buttonExtract_Click(object sender, EventArgs e)
        {
            ...
            {
                textBox2.Text += "http://gp.se/image" + match + Environment.NewLine;
                _imageArray[countedImages] = "http://gp.se/image" + match.Value;
                countedImages++;
            }
        ...
        public async Task DownloadImages()
        {
            ...
            for (int i = 0; i < _imageArray.Length; i++)
            {
                ...
                File.WriteAllBytes(_folderpath + $"/image{i}{format}", imageBytes);
